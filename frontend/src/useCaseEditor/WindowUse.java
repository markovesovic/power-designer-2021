...
public class WindowUse extends JFrame {
	
	private CanvasAreaUse canvas;
	public ToolBoxUse toolbox;
	public SelectionPanelUse selectionPanel;
	
	private EnvUse env;
	private File file;
	
	public WindowUse(String filePath) {
		EnvUse.CreateInstance(this); 
		env = EnvUse.getInstance();
		...
		canvas = new CanvasAreaUse(env);
		toolbox = new ToolBoxUse(this, env, canvas);
		selectionPanel = new SelectionPanelUse(this, env);
		CanvasMouseListenerUse cml = new CanvasMouseListenerUse(canvas, env);
