...
public class SelectionUse
{
	...
	public SelectionUse(Color colorStroke, Color colorBackground, int x, int y, int width, int height) {
	...
	public SelectionUse(Color colorStroke, Color colorBackground, Point_2D a, Point_2D b) {
